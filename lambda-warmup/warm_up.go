...
func init() {
	...
	anlogger.Debugf(nil, "warm_up_actions.go : aws session was successfully initialized")

	clientLambda = lambda.New(awsSession)
	anlogger.Debugf(nil, "warm_up_actions.go : lambda client was successfully initialized")
}
